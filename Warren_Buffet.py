...
metric = ['Market Cap', 'P/E', 'EPS (ttm)', 'Dividend', 'Dividend %', 'Shs Outstand', 'Price']
...
class Warren_Buffet(object):
    ...
    SUMMARY_DATA = {"Market Cap":" ", "P/E": " ", "EPS (ttm)":" ", "Dividend": " ", "Dividend %": " ", "Shs Outstand": " ", "Price": " "}
    ...
    def mw_scraper(self):
        ...
        try:
            mw_url = Warren_Buffet.URLS[4].format(self.ticker)
